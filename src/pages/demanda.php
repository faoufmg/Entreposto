...
$PesquisaProduto = mysqli_query($conn, "SELECT DISTINCT CONCAT(UCASE(LEFT(Nome, 1)), LCASE(SUBSTRING(Nome, 2))) AS Nome, Quantidade FROM Entrada ORDER BY Nome ASC");
                ...
                <form action="../Funcoes/FuncaoDemanda.php" method="POST" enctype=multipart/form-data>
                    <div class="form-row">
                        <div class="form-group col-md-6 col-lg-6">
                            ...
                            <select class="selectpicker" data-width="100%" data-size="4" id="SeletorProduto"
