<?php
  ...
  $Entrada = mysqli_query($link, "SELECT * FROM Entrada WHERE DataCad BETWEEN '$data_inicio' AND '$data_fim'");

  $Saida = mysqli_query($link, "SELECT * FROM Saida WHERE DataSaida BETWEEN '$data_inicio' AND '$data_fim'");

  $Demanda = mysqli_query($link, "SELECT * FROM Demanda WHERE DataDemanda BETWEEN '$data_inicio' AND '$data_fim'");
